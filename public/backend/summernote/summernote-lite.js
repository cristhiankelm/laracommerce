    ...
    return /******/ (function (modules) {
        ...
        /******/ {
                        ...
                        return function () {
                            const options =
                                typeof arguments[1] === "object"
                                    ? arguments[1]
                                    : arguments[0];
                            let children = Array.isArray(arguments[0])
                                ? arguments[0]
                                : [];
            ...
            /***/ 3: /***/ function (
                ...
                function listDescendant(node, pred) {
                    ...
                    (function fnWalk(current) {
                        ...
                        for (
                            let idx = 0, len = current.childNodes.length;
                            idx < len;
                            idx++
                        ) {
                ...
                function isLeftEdgePointOf(point, ancestor) {
                    return (
                        ...
                        isLeftEdgeOf(point.node, ancestor)
                    );
                }
                /**
                ...
                function splitNode(point, options) {
                    let isSkipPaddingBlankHTML =
                        options && options.isSkipPaddingBlankHTML;
                    const isNotSplitEdgePoint =
                        ...
                        summernote: function () {
                            ...
                            this.each((idx, note) => {
                                ...
                                if (!$note.data("summernote")) {
                                    const context = new Context_Context(
                                        $note,
                                        options,
                                    );
                ...
                function pointToTextRange(point) {
                    const textRangeInfo = function (container, offset) {
                        ...
                        if (dom.isText(container)) {
                            const prevTextNodes = dom.listPrev(
                                container,
                                func.not(dom.isText),
                            );
                            const prevContainer =
                ...
                class range_WrappedRange {
                    ...
                    normalize() {
                         ...
                         * @return {BoundaryPoint}
                         */
                        const getVisiblePoint = function (
                            point,
                            isLeftToRight,
                        ) {
                            if (!point) {
                        ...
                        const endPoint = getVisiblePoint(
                            this.getEndPoint(),
                            false,
                        );
                    ...
                    deleteContents() {
                        ...
                        const point = dom.prevPointUntil(
                            rng.getStartPoint(),
                            function (point) {
                    ...
                    wrapBodyInlineWithPara() {
                        ...
                        if (dom.isInline(rng.sc)) {
                            const ancestors = dom.listAncestor(
                                rng.sc,
                    ...
                    getWordRange(findAfter) {
                        ...
                        const startPoint = dom.prevPointUntil(
                            endPoint,
                            function (point) {
                    ...
                    getWordsMatchRange(regex) {
                        ...
                        var startPoint = dom.prevPointUntil(
                            ...
                            function (point) {
                                ...
                                var rng = new range_WrappedRange(
                                    point.node,
                                    point.offset,
                                    endPoint.node,
                                    endPoint.offset,
                ...
                /* harmony default export */ var core_range = {
                    ...
                    createFromBodyElement: function (
                        bodyElement,
                        isCollapseToStart = false,
                    ) {
                    ...
                    createFromSelection: function () {
                        ...
                        if (env.isW3CRangeSupport) {
                            ...
                            let startPoint = textRangeToPoint(
                                textRangeStart,
                                true,
                            );
                            let endPoint = textRangeToPoint(
                                textRangeEnd,
                                false,
                    ...
                    createFromBookmark: function (editable, bookmark) {
                        const sc = dom.fromOffsetPath(
                            editable,
                            bookmark.s.path,
                        );
                        const so = bookmark.s.offset;
                        const ec = dom.fromOffsetPath(
                            editable,
                            bookmark.e.path,
                        );
                    ...
                    styleNodes(rng, options) {
                        ...
                        if (expandClosestSibling) {
                            ...
                            return nodes.map((node) => {
                                const siblings = dom.withClosestSiblings(
                                    node,
                                    pred,
                                );
                ...
                class Bullet_Bullet {
                    ...
                    indent(editable) {
                        const rng = core_range
                            .create(editable)
                            .wrapBodyInlineWithPara();
                        const paras = rng.nodes(dom.isPara, {
                            includeAncestor: true,
                        });
                        const clustereds = lists.clusterBy(
                            paras,
                        ...
                        external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.each(
                            ...
                            (idx, paras) => {
                                ...
                                if (dom.isLi(head)) {
                                    const previousList = this.findList(
                    ...
                    findList(node) {
                        return node
                            ? lists.find(
                                  node.children,
                                  (child) =>
                                      ["OL", "UL"].indexOf(child.nodeName) > -1,
                              )
                            : null;
                    }
                    /**
                        ...
                        if (splitRoot) {
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    this.options.blockquoteBreakingLevel === 2
                                ) {
                ...
                const TableResultAction = function (
                    startPoint,
                    where,
                    action,
                    domTable,
                    ...
                    function addCellInfoToVirtual(row, cell) {
                        const cellIndex = recoverCellIndex(
                            row.rowIndex,
                            cell.cellIndex,
                        );
                        ...
                        if (colspanNumber > 1) {
                            for (let cp = 1; cp < colspanNumber; cp++) {
                                const cellspanIndex = recoverCellIndex(
                                    row.rowIndex,
                                    cellIndex + cp,
                                );
                                adjustStartPoint(
                ...
                class Table_Table {
                    ...
                    addRow(rng, position) {
                        ...
                        for (
                            ...
                            const tdAttributes = this.recoverAttributes(
                ...
                class Editor_Editor {
                    constructor(context) {
                        ...
                        this.pasteHTML = this.wrapCommand((markup) => {
                            ...
                            markup = this.context.invoke(
                                "codeview.purify",
                                markup,
                            );
                            const contents =
                                this.getLastRange().pasteHTML(markup);
                            this.setLastRange(
                                core_range
                        ...
                        this.formatBlock = this.wrapCommand(
                            (tagName, $target) => {
                                const onApplyCustomStyle =
                                    this.options.callbacks.onApplyCustomStyle;
                        ...
                        this.insertHorizontalRule = this.wrapCommand(() => {
                            const hrNode = this.getLastRange().insertNode(
                                dom.create("HR"),
                            );
                        ...
                        this.createLink = this.wrapCommand((linkInfo) => {
                            ...
                            const additionalTextLength =
                                linkText.length - rng.toString().length;

                            if (
                                additionalTextLength > 0 &&
                                this.isLimited(additionalTextLength)
                            ) {
                                return;
                            }
                            ...
                            const startRange = core_range.createFromNodeBefore(
                                lists.head(anchors),
                            );
                            const startPoint = startRange.getStartPoint();
                            const endRange = core_range.createFromNodeAfter(
                                lists.last(anchors),
                            );
                            ...
                            .on("keydown", (event) => {
                                ...
                                if (!event.isDefaultPrevented()) {
                                    if (this.options.shortcuts) {
                                        ...
                                        this.preventDefaultEditableShortCuts(
                                            event,
                                        );
                                    }
                                }
                    ...
                    setLastRange(rng) {
                        if (rng) {
                            ...
                            if (
                                ...
                                this.lastRange =
                                    core_range.createFromBodyElement(
                                        this.editable,
                                    );
                            }
                        }
                ...
                class Dropzone_Dropzone {
                    ...
                    attachDragAndDropEvent() {
                        let collection =
                            external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()();
                        const $dropzoneMessage = this.$dropzone.find(
                            ".note-dropzone-message",
                        );

                        this.documentEventHandlers.onDragenter = (e) => {
                            const isCodeview = this.context.invoke(
                                "codeview.isActivated",
                            );
                            const hasEditorSize =
                                this.$editor.width() > 0 &&
                                this.$editor.height() > 0;
                ...
                class Handle_Handle {
                    ...
                    update(target, event) {
                        ...
                        const $selection = this.$handle.find(
                ...
                class Buttons_Buttons {
                    ...
                    addToolbarButtons() {
                                    ...
                                    this.ui.dropdown({
                                        ...
                                        template: (item) => {
                                            if (typeof item === "string") {
                                                item = {
                                                    tag: item,
                                                    title: this.lang.style.hasOwnProperty(
                                                        item,
                                                    )
                        ...
                        this.context.memo("button.italic", () => {
                            return this.button({
                                ...
                                contents: this.ui.icon(
                                    this.options.icons.italic,
                                ),
                                tooltip:
                                    this.lang.font.italic +
                        ...
                        this.context.memo("button.underline", () => {
                            return this.button({
                                ...
                                contents: this.ui.icon(
                                    this.options.icons.underline,
                                ),
                                tooltip:
                                    this.lang.font.underline +
                        ...
                        this.context.memo("button.clear", () => {
                            return this.button({
                                contents: this.ui.icon(
                                    this.options.icons.eraser,
                                ),
                                tooltip:
                                    this.lang.font.clear +
                                    this.representShortcut("removeFormat"),
                                click: this.context.createInvokeHandler(
                                    "editor.removeFormat",
                                ),
                            }).render();
                        ...
                        this.context.memo("button.strikethrough", () => {
                            return this.button({
                                ...
                                contents: this.ui.icon(
                                    this.options.icons.strikethrough,
                                ),
                                tooltip:
                        ...
                        this.context.memo("button.superscript", () => {
                            return this.button({
                                ...
                                contents: this.ui.icon(
                                    this.options.icons.superscript,
                                ),
                        ...
                        this.context.memo("button.fontname", () => {
                            const styleInfo = this.context.invoke(
                                "editor.currentStyle",
                            );
                                ...
                                external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.each(
                                    ...
                                    (idx, fontname) => {
                                        ...
                                        if (
                                            ...
                                            if (
                                                this.options.fontNames.indexOf(
                                                    fontname,
                                                ) === -1
                                            ) {
                                                this.options.fontNames.push(
                                                    fontname,
                                                );
                                            }
                                        }
                        ...
                        this.context.memo("button.ul", () => {
                            return this.button({
                                contents: this.ui.icon(
                                    this.options.icons.unorderedlist,
                                ),
                                tooltip:
                        ...
                        this.context.memo("button.ol", () => {
                            return this.button({
                                contents: this.ui.icon(
                                    this.options.icons.orderedlist,
                                ),
                                tooltip:
                                    this.lang.lists.ordered +
                                    this.representShortcut("insertOrderedList"),
                                click: this.context.createInvokeHandler(
                        ...
                        this.context.memo("button.link", () => {
                            return this.button({
                                ...
                                tooltip:
                                    this.lang.link.link +
                                    this.representShortcut("linkDialog.show"),
                                click: this.context.createInvokeHandler(
                                    "linkDialog.show",
                                ),
                            }).render();
                        ...
                        this.context.memo("button.redo", () => {
                            return this.button({
                                ...
                                tooltip:
                                    this.lang.history.redo +
                                    this.representShortcut("redo"),
                                click: this.context.createInvokeHandler(
                                    "editor.redo",
                                ),
                            }).render();
                        ...
                        this.context.memo("button.undo", () => {
                            return this.button({
                                ...
                                tooltip:
                                    this.lang.history.undo +
                                    this.representShortcut("undo"),
                                click: this.context.createInvokeHandler(
                                    "editor.undo",
                                ),
                            }).render();
                    ...
                    build($container, groups) {
                        for (
                            ...
                            for (
                                let idx = 0, len = buttons.length;
                                idx < len;
                                idx++
                            ) {
                                const btn = this.context.memo(
                                    "button." + buttons[idx],
                                );
                    ...
                    updateCurrentStyle($container) {
                        ...
                        if (styleInfo["font-family"]) {
                            const fontNames = styleInfo["font-family"]
                                .split(",")
                                .map((name) => {
                                    return name
                                        .replace(/[\'\"]/g, "")
                    ...
                    tableMoveHandler(event) {
                        ...
                        const $catcher = $picker.find(
                            ".note-dimension-picker-mousecatcher",
                        );
                        const $highlighted = $picker.find(
                            ".note-dimension-picker-highlighted",
                        );
                        const $unhighlighted = $picker.find(
                ...
                class LinkDialog_LinkDialog {
                    ...
                    showLinkDialog(linkInfo) {
                        return external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a
                            .Deferred((deferred) => {
                                const $linkText =
                                    this.$dialog.find(".note-link-text");
                                const $linkUrl =
                                    this.$dialog.find(".note-link-url");
                                const $linkBtn =
                                    this.$dialog.find(".note-link-btn");
                ...
                class ImageDialog_ImageDialog {
                    ...
                    showImageDialog() {
                        return external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.Deferred(
                            (deferred) => {
                                const $imageInput =
                                    this.$dialog.find(".note-image-input");
                                const $imageUrl =
                                    this.$dialog.find(".note-image-url");
                                const $imageBtn =
                                    this.$dialog.find(".note-image-btn");
                                this.ui.onDialogShown(this.$dialog, () => {
                ...
                class VideoDialog_VideoDialog {
                    ...
                    show() {
                        const text = this.context.invoke(
                    ...
                    showVideoDialog(text) {
                        return external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.Deferred(
                            (deferred) => {
                                const $videoUrl =
                                    this.$dialog.find(".note-video-url");
                                const $videoBtn =
                                    this.$dialog.find(".note-video-btn");
                                this.ui.onDialogShown(this.$dialog, () => {
                ...
                class HelpDialog_HelpDialog {
                    ...
                    initialize() {
                        ...
                        const body = [
                            '<p class="text-center">',
                            '<a href="http://summernote.org/" target="_blank">Summernote 0.8.15</a> · ',
                            ...
                            .map((key) => {
                                ...
                                $row.append(
                                    ...
                                    external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                                        ...
                                        this.context.memo("help." + command) ||
                                            command,
                                    ),
                                );
                                return $row.html();
                ...
                class AirPopover_AirPopover {
                    ...
                    update() {
                        ...
                        if (styleInfo.range && !styleInfo.range.isCollapsed()) {
                            const rect = lists.last(
                                styleInfo.range.getClientRects(),
                            );
                ...
                class HintPopover_HintPopover {
                    ...
                    moveDown() {
                        const $current = this.$content.find(
                    ...
                    createItemTemplates(hintIdx, items) {
                        ...
                        return items.map((item, idx) => {
                            ...
                            $item.append(
                                hint.template ? hint.template(item) : item + "",
                            );
                            $item.data({
                                index: hintIdx,
                                item: item,
                    ...
                    createGroup(idx, keyword) {
                        ...
                        this.searchKeyword(idx, keyword, (items) => {
                            ...
                            if (items.length) {
                                $group.html(
                                    this.createItemTemplates(idx, items),
                                );
                                this.show();
                            }
                        });
                            ...
                            if (this.options.hintMode === "words") {
                                ...
                                this.hints.forEach((hint) => {
                                    if (hint.match.test(keyword)) {
                                        wordRange = range.getWordsMatchRange(
                                            hint.match,
                                        );
                                        return false;
                                    }
            ...
            /***/ 50: /***/ function (
                ...
                const editor = renderer["a" /* default */].create(
                    '<div class="note-editor note-frame"/>',
                );
                const toolbar = renderer["a" /* default */].create(
                    '<div class="note-toolbar" role="toolbar"/>',
                );
                const editingArea = renderer["a" /* default */].create(
                    '<div class="note-editing-area"/>',
                );
                const codable = renderer["a" /* default */].create(
                    '<textarea class="note-codable" aria-multiline="true"/>',
                );
                const editable = renderer["a" /* default */].create(
                    '<div class="note-editable" contentEditable="true" role="textbox" aria-multiline="true"/>',
                );
                const statusbar = renderer["a" /* default */].create(
                    [
                ...
                const airEditor = renderer["a" /* default */].create(
                    '<div class="note-editor note-airframe"/>',
                );
                const airEditable = renderer["a" /* default */].create(
                    [
                        '<div class="note-editable" contentEditable="true" role="textbox" aria-multiline="true"/>',
                        '<output class="note-status-output" role="status" aria-live="polite"/>',
                    ].join(""),
                );
                const buttonGroup = renderer["a" /* default */].create(
                    '<div class="note-btn-group">',
                );
                const ui_button = renderer["a" /* default */].create(
                ...
                const dropdown = renderer["a" /* default */].create(
                ...
                const dropdownCheck = renderer["a" /* default */].create(
                ...
                const palette = renderer["a" /* default */].create(
                    ...
                    function ($node, options) {
                        ...
                        for (
                            ...
                            for (
                                let col = 0, colSize = colors.length;
                                col < colSize;
                                col++
                            ) {
                ...
                const dialog = renderer["a" /* default */].create(
                ...
                const popover = renderer["a" /* default */].create(
                    [
                ...
                const ui_checkbox = renderer["a" /* default */].create(
