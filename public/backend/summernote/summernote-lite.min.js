...
!(function (t, e) {
    ...
    return (function (t) {
            ...
            class s {
                ...
                render(t) {
                    ...
                    if (
                        ...
                        this.options &&
                            this.options.data &&
                            n.a.each(this.options.data, (t, o) => {
                                e.attr("data-" + t, o);
                            }),
                        this.options &&
                            this.options.click &&
        ...
        3: function (t, e, o) {
            ...
            var i = o(0),
                n = o.n(i);
            (n.a.summernote = n.a.summernote || { lang: {} }),
            ...
            if (c) {
                ...
                t && (d = parseFloat(t[1])),
                    (t = /Trident\/.*rv:([0-9]{1,}[.0-9]{0,})/.exec(l)),
                    t && (d = parseFloat(t[1]));
            }
            const h = /Edge\/\d+/.test(l);
            ...
            var f = {
                ...
                isFontInstalled: function (t) {
                    ...
                    return (
                        (o.font = "200px " + a(t) + ', "' + e + '"'),
                        i !== o.measureText("mmmmmmmmmmwwwww").width
                    );
                },
            ...
            function W(t) {
                ...
                return (
                    0 === e ||
                    (!I(t) && 1 === e && t.innerHTML === U) ||
                    !(!y.all(t.childNodes, I) || "" !== t.innerHTML)
                );
            }
            function K(t) {
            ...
            function it(t, e) {
                ...
                if (0 === t.offset) {
                    ...
                    ot(t.node)
                        ? ((o = t.node.childNodes[t.offset - 1]), (i = j(o)))
                        : ((o = t.node), (i = e ? 0 : t.offset - 1));
            ...
            function nt(t, e) {
                ...
                if (j(t.node) === t.offset) {
                    ...
                    if (((o = t.node.childNodes[t.offset]), (i = 0), W(o)))
                        return null;
                } else if (
                    ((o = t.node), (i = e ? j(t.node) : t.offset + 1), W(o))
                )
                    return null;
                return { node: o, offset: i };
            }
            ...
            function rt(t, e) {
                ...
                if (I(t.node)) return t.node.splitText(t.offset);
                {
                    const e = t.node.childNodes[t.offset],
                        i = G(t.node.cloneNode(!1), t.node);
                    return (
                        Z(i, _(e)),
                        o || (K(t.node), K(i)),
                        n && (W(t.node) && ct(t.node), W(i))
                            ? (ct(i), t.node.nextSibling)
                            : i
                    );
                }
            }
            ...
            function ct(t, e) {
                ...
                if (!e) {
                    ...
                    for (let o = 0, i = t.childNodes.length; o < i; o++)
                        e.push(t.childNodes[o]);
                    for (let i = 0, n = e.length; i < n; i++)
                        o.insertBefore(e[i], t);
                }
                o.removeChild(t);
            }
            const dt = $("TEXTAREA");
            ...
            var ut = {
                ...
                listDescendant: function (t, e) {
                    ...
                    return (
                        ...
                        (function i(n) {
                            t !== n && e(n) && o.push(n);
                            for (let t = 0, e = n.childNodes.length; t < e; t++)
                                i(n.childNodes[t]);
                        })(t),
                        o
                    );
                ...
                splitPoint: function (t, e) {
                    ...
                    return (
                        a || r !== t.node || (a = t.node.childNodes[t.offset]),
                        { rightNode: a, container: r }
                    );
                },
                create: lt,
                ...
                isCustomStyleTag: function (t) {
                    return (
                        t && !I(t) && y.contains(t.classList, "note-styletag")
                    );
                },
            };
            class pt {
                constructor(t, e) {
                    (this.$note = t),
                        ...
                        (this.modules = {}),
                        (this.layoutInfo = {}),
                        (this.options = n.a.extend(!0, {}, e)),
                        (n.a.summernote.ui = n.a.summernote.ui_template(
                            this.options,
                        )),
                        (this.ui = n.a.summernote.ui),
                        this.initialize();
                }
                initialize() {
                    return (
                ...
                reset() {
                    ...
                    this.code(ut.emptyPara),
                        this._destroy(),
                        this._initialize(),
                        t && this.disable();
                }
                _initialize() {
                    (this.options.id = b.uniqueId(n.a.now())),
                ...
                initializeModule(t) {
                    ...
                    (e.shouldInitialize = e.shouldInitialize || b.ok),
                        e.shouldInitialize() &&
                            ...
                            e.events && ut.attachEvents(this.$note, e.events));
                }
                module(t, e, o) {
                ...
                removeModule(t) {
                    const e = this.modules[t];
                    e.shouldInitialize() &&
                        (e.events && ut.detachEvents(this.$note, e.events),
                        e.destroy && e.destroy()),
                ...
                createInvokeHandlerAndUpdateState(t, e) {
                    return (o) => {
                        this.createInvokeHandler(t, e)(o),
                ...
                createInvokeHandler(t, e) {
                    return (o) => {
                        ...
                        this.invoke(
                            t,
                            e || i.closest("[data-value]").data("value"),
                            i,
                        );
                    };
                }
            ...
            function mt(t, e) {
                ...
                for (o = 0; o < r.length; o++)
                    if (!ut.isText(r[o])) {
                        if (
                            (n.moveToElementText(r[o]),
                            n.compareEndPoints("StartToStart", t) >= 0)
                        )
                            break;
                        s = r[o];
                    }
                if (0 !== o && ut.isText(r[o - 1])) {
                    const n = document.body.createTextRange();
                    let r = null;
                    n.moveToElementText(s || i),
                        n.collapse(!s),
                        (r = s ? s.nextSibling : i.firstChild);
                    const a = t.duplicate();
                    a.setEndPoint("StartToStart", n);
                    let l = a.text.replace(/[\r\n]/g, "").length;
                    for (; l > r.nodeValue.length && r.nextSibling; )
                        (l -= r.nodeValue.length), (r = r.nextSibling);
                    r.nodeValue;
                    e &&
                        r.nextSibling &&
                        ut.isText(r.nextSibling) &&
            ...
            function ft(t) {
                const e = function (t, o) {
                        let i, n;
                        if (ut.isText(t)) {
                            const e = ut.listPrev(t, b.not(ut.isText)),
                                s = y.last(e).previousSibling;
                            (i = s || t.parentNode),
                                (o += y.sum(y.tail(e), ut.nodeLength)),
                                (n = !s);
                        } else {
                            if (((i = t.childNodes[o] || t), ut.isText(i)))
                                return e(i, 0);
                            (o = 0), (n = !1);
                        }
                    ...
                    i = e(t.node, t.offset);
                return (
                    o.moveToElementText(i.node),
                    o.collapse(i.collapseToStart),
                    o.moveStart("character", i.offset),
                    o
                );
            }
            n.a.fn.extend({
                summernote: function () {
                    const t = n.a.type(y.head(arguments)),
                        e = "string" === t,
                        o = "object" === t,
                        i = n.a.extend(
                            {},
                            n.a.summernote.options,
                            o ? y.head(arguments) : {},
                        );
                    (i.langInfo = n.a.extend(
                        !0,
                        {},
                        n.a.summernote.lang["en-US"],
                        n.a.summernote.lang[i.lang],
                    )),
                        (i.icons = n.a.extend(
                            !0,
                            {},
                            n.a.summernote.options.icons,
                            i.icons,
                        )),
                        (i.tooltip =
                            "auto" === i.tooltip
                        ...
                        this.each((t, e) => {
                            ...
                            if (!o.data("summernote")) {
                                ...
                                o.data("summernote", t),
                                    o
                                        .data("summernote")
                                        .triggerEvent("init", t.layoutInfo);
                            }
                        });
                    const s = this.first();
                    if (s.length) {
            ...
            class gt {
                constructor(t, e, o, i) {
                    (this.sc = t),
                        ...
                        (this.ec = o),
                        (this.eo = i),
                        (this.isOnEditable = this.makeIsOn(ut.isEditable)),
                        (this.isOnList = this.makeIsOn(ut.isList)),
                        (this.isOnAnchor = this.makeIsOn(ut.isAnchor)),
                        (this.isOnCell = this.makeIsOn(ut.isCell)),
                        (this.isOnData = this.makeIsOn(ut.isData));
                }
                nativeRange() {
                    ...
                    }
                    {
                        ...
                        return (
                            t.setEndPoint(
                                "EndToEnd",
                                ft({ node: this.ec, offset: this.eo }),
                            ),
                            t
                        );
                    }
                ...
                normalize() {
                    const t = function (t, e) {
                            ...
                            if (
                                ut.isVisiblePoint(t) &&
                                (!ut.isEdgePoint(t) ||
                                    (ut.isRightEdgePoint(t) && !e) ||
                                    (ut.isLeftEdgePoint(t) && e) ||
                                    (ut.isRightEdgePoint(t) &&
                                        e &&
                                        ut.isVoid(t.node.nextSibling)) ||
                                    (ut.isLeftEdgePoint(t) &&
                                        !e &&
                                        ut.isVoid(t.node.previousSibling)) ||
                                    (ut.isBlock(t.node) && ut.isEmpty(t.node)))
                            )
                                return t;
                    ...
                    return (
                        ut.walkPoint(
                            ...
                            function (e) {
                                ...
                                let n;
                                i
                                    ? (ut.isLeftEdgePoint(e) && a.push(e.node),
                                      ut.isRightEdgePoint(e) &&
                                          y.contains(a, e.node) &&
                                          (n = e.node))
                                    : (n = o ? ut.ancestor(e.node, t) : e.node),
                                    n && t(n) && r.push(n);
                            },
                            !0,
                        ),
                ...
                expand(t) {
                    ...
                    if (!e && !o)
                        return new gt(this.sc, this.so, this.ec, this.eo);
                    const i = this.getPoints();
                    return (
                        e && ((i.sc = e), (i.so = 0)),
                        o && ((i.ec = o), (i.eo = ut.nodeLength(o))),
                        new gt(i.sc, i.so, i.ec, i.eo)
                    );
                }
                collapse(t) {
                    return t
                        ? new gt(this.sc, this.so, this.sc, this.so)
                        : new gt(this.ec, this.eo, this.ec, this.eo);
                }
                splitText() {
                    ...
                    return (
                        ut.isText(this.ec) &&
                            !ut.isEdgePoint(this.getEndPoint()) &&
                            this.ec.splitText(this.eo),
                        ut.isText(this.sc) &&
                            !ut.isEdgePoint(this.getStartPoint()) &&
                            ((e.sc = this.sc.splitText(this.so)),
                            (e.so = 0),
                            t && ((e.ec = e.sc), (e.eo = this.eo - this.so))),
                        new gt(e.sc, e.so, e.ec, e.eo)
                    );
                }
                deleteContents() {
                    ...
                    const t = this.splitText(),
                        ...
                        i = [];
                    return (
                        n.a.each(e, function (t, e) {
                            const n = e.parentNode;
                            o.node !== n && 1 === ut.nodeLength(n) && i.push(n),
                                ut.remove(e, !1);
                        }),
                ...
                wrapBodyInlineWithPara() {
                    if (ut.isBodyContainer(this.sc) && ut.isEmpty(this.sc))
                        return (
                            (this.sc.innerHTML = ut.emptyPara),
                            new gt(this.sc.firstChild, 0, this.sc.firstChild, 0)
                        );
                    const t = this.normalize();
                    if (ut.isParaInline(this.sc) || ut.isPara(this.sc))
                        return t;
                    let e;
                    if (ut.isInline(t.sc)) {
                ...
                getWordRange(t) {
                    ...
                    return (
                        t &&
                            (e = ut.nextPointUntil(e, function (t) {
                                return !ut.isCharPoint(t);
                            })),
                ...
                getWordsRange(t) {
                    ...
                    return (
                        t && (e = ut.nextPointUntil(e, o)),
                        new gt(i.node, i.offset, e.node, e.offset)
                    );
                }
                getWordsMatchRange(t) {
                    var e = this.getEndPoint(),
                        o = ut.prevPointUntil(e, function (o) {
                            if (!ut.isCharPoint(o) && !ut.isSpacePoint(o))
                                return !0;
            ...
            var bt = {
                create: function (t, e, o, i) {
                    ...
                    if (2 === arguments.length)
                        return new gt(t, e, (o = t), (i = e));
                    {
                        let t = this.createFromSelection();
                        if (!t && 1 === arguments.length) {
                            let t = arguments[0];
                            return (
                                ut.isEditable(t) && (t = t.lastChild),
                                this.createFromBodyElement(
                                    t,
                                    ut.emptyPara === arguments[0].innerHTML,
                                )
                            );
                        }
                        return t;
                ...
                createFromSelection: function () {
                    ...
                    if (f.isW3CRangeSupport) {
                        ...
                        let a = mt(r, !0),
                            l = mt(s, !1);
                        ut.isText(a.node) &&
                            ut.isLeftEdgePoint(a) &&
                            ut.isTextNode(l.node) &&
                            ut.isRightEdgePoint(l) &&
                            l.node.nextSibling === a.node &&
                            (a = l),
                            (t = a.cont),
                            (e = a.offset),
                            (o = l.cont),
                ...
                createFromNode: function (t) {
                    ...
                    return (
                        ut.isVoid(e) &&
                            ((o = ut.listPrev(e).length - 1),
                            (e = e.parentNode)),
                        ut.isBR(i)
                            ? ((n = ut.listPrev(i).length - 1),
                              (i = i.parentNode))
                            : ut.isVoid(i) &&
                              ((n = ut.listPrev(i).length), (i = i.parentNode)),
                        this.create(e, o, i, n)
                    );
                },
                ...
                createFromBookmark: function (t, e) {
                    const o = ut.fromOffsetPath(t, e.s.path),
                        i = e.s.offset,
            ...
            var kt = {
                isEdit: (t) =>
                    y.contains(
                        [vt.BACKSPACE, vt.TAB, vt.ENTER, vt.SPACE, vt.DELETE],
                        t,
                    ),
                isMove: (t) =>
                    y.contains([vt.LEFT, vt.UP, vt.RIGHT, vt.DOWN], t),
                isNavigation: (t) =>
                    y.contains([vt.HOME, vt.END, vt.PAGEUP, vt.PAGEDOWN], t),
            ...
            class wt {
                ...
                stylePara(t, e) {
                    n.a.each(
                        t.nodes(ut.isPara, { includeAncestor: !0 }),
                        (t, o) => {
                            n()(o).css(e);
                        },
                    );
                ...
                styleNodes(t, e) {
                    ...
                    const a = t
                        .nodes(ut.isText, { fullyContains: !0 })
                        .map(
                            (t) =>
                                ut.singleChildAncestor(t, r) || ut.wrap(t, o),
                        );
                    if (i) {
                        if (s) {
                            const e = t.nodes();
                        ...
                        return a.map((t) => {
                            const e = ut.withClosestSiblings(t, r),
                                o = y.head(e),
                                i = y.tail(e);
                            return (
                                n.a.each(i, (t, e) => {
                                    ut.appendChildNodes(o, e.childNodes),
                                        ut.remove(e);
                                }),
                                y.head(e)
                            );
                ...
                current(t) {
                    ...
                    return (
                        (o.anchor =
                            t.isOnAnchor() && ut.ancestor(t.sc, ut.isAnchor)),
                        (o.ancestors = ut.listAncestor(t.sc, ut.isEditable)),
                        (o.range = t),
                        o
                    );
                }
            ...
            class yt {
                ...
                indent(t) {
                    const e = bt.create(t).wrapBodyInlineWithPara(),
                        o = e.nodes(ut.isPara, { includeAncestor: !0 }),
                    ...
                    n.a.each(i, (t, e) => {
                        ...
                        if (ut.isLi(o)) {
                            ...
                            t
                                ? e.map((e) => t.appendChild(e))
                                : (this.wrapList(e, o.parentNode.nodeName),
                                  e
                                      .map((t) => t.parentNode)
                                      .map((t) => this.appendToPrevious(t)));
                        } else
                            n.a.each(e, (t, e) => {
                                n()(e).css(
                                    "marginLeft",
                                    (t, e) => (parseInt(e, 10) || 0) + 25,
                                );
                            });
                    }),
                        e.select();
                ...
                outdent(t) {
                    ...
                    n.a.each(i, (t, e) => {
                        ...
                        ut.isLi(o)
                            ? this.releaseList([e])
                            : n.a.each(e, (t, e) => {
                                  n()(e).css("marginLeft", (t, e) =>
                                      (e = parseInt(e, 10) || 0) > 25
                                          ? e - 25
                                          : "",
                                  );
                              });
                ...
                toggleList(t, e) {
                    ...
                    if (y.find(i, ut.isPurePara)) {
                        ...
                        const e = o
                            .nodes(ut.isList, { includeAncestor: !0 })
                ...
                wrapList(t, e) {
                    ...
                    return (
                        (t = t.map((t) =>
                            ut.isPurePara(t) ? ut.replace(t, "LI") : t,
                        )),
                        ut.appendChildNodes(r, t),
                        s &&
                            (ut.appendChildNodes(r, y.from(s.childNodes)),
                            ut.remove(s)),
                        t
                    );
                }
                    ...
                    return (
                        n.a.each(t, (t, i) => {
                            const s = y.head(i),
                                r = y.last(i),
                                a = e
                                    ? ut.lastAncestor(s, ut.isList)
                                    : s.parentNode,
                                l = a.parentNode;
                            if ("LI" === a.parentNode.nodeName)
                                i.map((t) => {
                                    ...
                                    l.nextSibling
                                        ...
                                        : l.parentNode.appendChild(t),
                                        e.length &&
                                            (this.wrapList(e, a.nodeName),
                                            t.appendChild(e[0].parentNode));
                                }),
                                    0 === a.children.length && l.removeChild(a),
                                ...
                                (i = e
                                    ? ut.listDescendant(o, ut.isLi)
                                    : y.from(o.childNodes).filter(ut.isLi)),
                                    (!e && ut.isList(a.parentNode)) ||
                                        (i = i.map((t) => ut.replace(t, "P"))),
                                    n.a.each(y.from(i).reverse(), (t, e) => {
                                        ut.insertAfter(e, a);
                                    });
                                const l = y.compact([a, o, t]);
                                n.a.each(l, (t, e) => {
                                    const o = [e].concat(
                                        ut.listDescendant(e, ut.isList),
                                    );
                ...
                appendToPrevious(t) {
                    return t.previousSibling
                        ? ut.appendChildNodes(t.previousSibling, [t])
                        : this.wrapList([t], "LI");
                }
                findList(t) {
                    return t
            ...
            class xt {
                ...
                insertTab(t, e) {
                    const o = ut.createText(
                        new Array(e + 1).join(ut.NBSP_CHAR),
                    );
                ...
                insertParagraph(t, e) {
                    ...
                    if (o) {
                        if (
                            ut.isLi(o) &&
                            (ut.isEmpty(o) || ut.deepestChildIsEmpty(o))
                        )
                            ...
                            );
                        {
                            ...
                            if (
                                (1 === this.options.blockquoteBreakingLevel
                                    ? (t = ut.ancestor(o, ut.isBlockquote))
                                    : 2 ===
                                          this.options
                                              .blockquoteBreakingLevel &&
                                      (t = ut.lastAncestor(o, ut.isBlockquote)),
                                t)
                            ) {
                                (i = n()(ut.emptyPara)[0]),
                                    ut.isRightEdgePoint(e.getStartPoint()) &&
                                        ut.isBR(e.sc.nextSibling) &&
                                        n()(e.sc.nextSibling).remove();
                                const o = ut.splitTree(t, e.getStartPoint(), {
                                ...
                                (t = t.concat(
                                    ut.listDescendant(i, ut.isEmptyAnchor),
                                )),
                                    n.a.each(t, (t, e) => {
                                        ut.remove(e);
                                    }),
            ...
            const St = function (t, e, o, i) {
                ...
                function l(t, e, o, i) {
                    return {
                        baseCell: t.baseCell,
                        action: e,
                        virtualTable: { rowIndex: o, cellIndex: i },
                    };
                }
                function c(t, e) {
                    if (!s[t]) return e;
                ...
                function d(t, e) {
                    ...
                    const l = e.attributes.rowSpan
                        ? parseInt(e.attributes.rowSpan.value, 10)
                        : 0;
                    if (l > 1)
                        for (let n = 1; n < l; n++) {
                            const s = t.rowIndex + n;
                            h(s, o, e, r), a(s, o, t, e, !0, i, !0);
                        }
                    const d = e.attributes.colSpan
                    ...
                    if (d > 1)
                        for (let i = 1; i < d; i++) {
                            ...
                            h(t.rowIndex, n, e, r),
                                a(t.rowIndex, n, t, e, s, !0, !0);
                        }
                }
                function h(t, e, o, i) {
                    t === n.rowPos &&
                        n.colPos >= o.cellIndex &&
                        o.cellIndex <= e &&
                        !i &&
                        n.colPos++;
                }
                function u(t) {
                    switch (e) {
                        case St.where.Column:
                            if (t.isColSpan)
                                return St.resultAction.SubtractSpanCount;
                            break;
                        case St.where.Row:
                ...
                function p(t) {
                    switch (e) {
                        case St.where.Column:
                            if (t.isColSpan)
                                return St.resultAction.SumSpanCount;
                            if (t.isRowSpan && t.isVirtual)
                                return St.resultAction.Ignore;
                            break;
                        case St.where.Row:
                            if (t.isRowSpan)
                                return St.resultAction.SumSpanCount;
                ...
                (this.getActionList = function () {
                    const t = e === St.where.Row ? n.rowPos : -1,
                    ...
                    (function () {
                        ...
                        for (let e = 0; e < t.length; e++) {
                            const o = t[e].cells;
                            for (let i = 0; i < o.length; i++) d(t[e], o[i]);
                        }
                    })();
            };
            (St.where = { Row: 0, Column: 1 }),
                (St.requestAction = { Add: 0, Delete: 1 }),
                (St.resultAction = {
                    Ignore: 0,
                    SubtractSpanCount: 1,
                    RemoveCell: 2,
            ...
            class $t {
                tab(t, e) {
                    const o = ut.ancestor(t.commonAncestor(), ut.isCell),
                        ...
                        switch (o.action) {
                            ...
                            case St.resultAction.SumSpanCount:
                                if ("top" === e) {
                                    if (
                                        (o.baseCell.parent
                                            ? o.baseCell.closest("tr").rowIndex
                                            : 0) <= i[0].rowIndex
                                    ) {
                                        const t = n()("<div></div>")
                                            .append(
                ...
                recoverAttributes(t) {
                    ...
                    for (let t = 0; t < o.length; t++)
                        "id" !== o[t].name.toLowerCase() &&
                            o[t].specified &&
                            (e += " " + o[t].name + "='" + o[t].value + "'");
                    return e;
                }
                deleteRow(t) {
                        ...
                        switch (r[t].action) {
                            ...
                            case St.resultAction.AddCell:
                                ...
                                a &&
                                    (l > 2
                                        ? (l--,
                                          t.insertBefore(r, t.cells[i]),
                                          t.cells[i].setAttribute("rowSpan", l),
                                          (t.cells[i].innerHTML = ""))
                                        : 2 === l &&
                                          (t.insertBefore(r, t.cells[i]),
                                          t.cells[i].removeAttribute("rowSpan"),
                                          (t.cells[i].innerHTML = "")));
                                continue;
                            ...
                            switch (s[t].action) {
                                ...
                                case St.resultAction.SubtractSpanCount:
                                    ...
                                    if (e.colSpan && e.colSpan > 1) {
                                        let t = e.colSpan
                                            ? parseInt(e.colSpan, 10)
                                            : 0;
                                        t > 2
                                            ? (t--,
                                              e.setAttribute("colSpan", t),
                                              e.cellIndex === i &&
                                                  (e.innerHTML = ""))
                                            : 2 === t &&
                ...
                createTable(t, e, o) {
                    ...
                    return (
                        o && o.tableClassName && l.addClass(o.tableClassName),
                        l[0]
                    );
                }
                deleteTable(t) {
                    ...
                    modules: {
                        editor: class {
                            constructor(t) {
                                (this.context = t),
                                    ...
                                    (this.style = new wt()),
                                    (this.table = new $t()),
                                    (this.typing = new xt(t)),
                                    (this.bullet = new yt()),
                                    (this.history = new Ct(this.$editable)),
                                    this.context.memo(
                                        "help.undo",
                                        this.lang.help.undo,
                                    ),
                                ...
                                (this.fontName = this.wrapCommand((t) =>
                                    this.fontStyling(
                                        "font-family",
                                        f.validFontName(t),
                                    ),
                                )),
                                    (this.fontSize = this.wrapCommand((t) => {
                                        const e =
                                            this.currentStyle()[
                                                "font-size-unit"
                                            ];
                                ...
                                (this.insertParagraph = this.wrapCommand(() => {
                                    ...
                                    (this.insertUnorderedList =
                                        this.wrapCommand(() => {
                                            this.bullet.insertUnorderedList(
                                                this.editable,
                                            );
                                        })),
                                    ...
                                    (this.insertNode = this.wrapCommand((t) => {
                                        if (
                                            this.isLimited(n()(t).text().length)
                                        )
                                            return;
                                        this.getLastRange().insertNode(t),
                                            this.setLastRange(
                                                bt
                                                    .createFromNodeAfter(t)
                                                    .select(),
                                            );
                                    })),
                                    (this.insertText = this.wrapCommand((t) => {
                                        ...
                                        const e =
                                            this.getLastRange().insertNode(
                                                ut.createText(t),
                                            );
                                        this.setLastRange(
                                            bt
                                                .create(e, ut.nodeLength(e))
                                                .select(),
                                        );
                                    })),
                                    (this.pasteHTML = this.wrapCommand((t) => {
                                        if (this.isLimited(t.length)) return;
                                        t = this.context.invoke(
                                            "codeview.purify",
                                            t,
                                        );
                                        const e =
                                            this.getLastRange().pasteHTML(t);
                                        this.setLastRange(
                                            bt
                                    ...
                                    (this.createLink = this.wrapCommand((t) => {
                                        ...
                                        if (l) {
                                            r = r.deleteContents();
                                            const t = r.insertNode(
                                                n()("<A>" + o + "</A>")[0],
                                            );
                                            c.push(t);
                                        } else
                                            c = this.style.styleNodes(r, {
                                                nodeName: "A",
                                        ...
                                        const d = bt
                                                .createFromNodeBefore(y.head(c))
                                                .getStartPoint(),
                                            h = bt
                                                .createFromNodeAfter(y.last(c))
                                                .getEndPoint();
                                        this.setLastRange(
                                            bt
                                                .create(
                                    ...
                                    (this.insertTable = this.wrapCommand(
                                        (t) => {
                                            const e = t.split("x");
                                            this.getLastRange()
                                                .deleteContents()
                            ...
                            initialize() {
                                this.$editable
                                    ...
                                    this.$editable.html(
                                        ut.html(this.$note) || ut.emptyPara,
                                    ),
                                    this.$editable.on(
                                        f.inputEventName,
                                        b.debounce(() => {
                            ...
                            handleKeyMap(t) {
                                ...
                                i && o.push(i);
                                const n = e[o.join("+")];
                                "TAB" !== i || this.options.tabDisable
                                    ? n
                                        ? !1 !== this.context.invoke(n) &&
                                          t.preventDefault()
                                        : kt.isEdit(t.keyCode) &&
                                          this.afterCommand()
                                    : this.afterCommand();
                            ...
                            insertImagesAsDataURL(t) {
                                n.a.each(t, (t, e) => {
                                    ...
                                    this.options.maximumImageFileSize < e.size
                                        ? this.context.triggerEvent(
                                              "image.upload.error",
                                              this.lang.image
                            ...
                            getLinkInfo() {
                                const t = this.getLastRange().expand(
                                        ut.isAnchor,
                                    ),
                            ...
                            isEmpty() {
                                return (
                                    ut.isEmpty(this.$editable[0]) ||
                                    ut.emptyPara === this.$editable.html()
                                );
                            }
                            empty() {
                        ...
                        dropzone: class {
                            ...
                            attachDragAndDropEvent() {
                                let t = n()();
                                const e = this.$dropzone.find(
                                    ".note-dropzone-message",
                                );
                                (this.documentEventHandlers.onDragenter = (
                                    o,
                                ) => {
                                    const i = this.context.invoke(
                                    ...
                                    i ||
                                        ...
                                        e.text(this.lang.image.dragImageHere)),
                                        (t = t.add(o.target));
                                }),
                        ...
                        codeview: class {
                            ...
                            activate() {
                                if (
                                    ...
                                    const t = It.fromTextArea(
                                        this.$codable[0],
                                        this.options.codemirror,
                                    );
                                    if (this.options.codemirror.tern) {
                                        const e = new It.TernServer(
                                            this.options.codemirror.tern,
                                        );
                                        (t.ternServer = e),
                                            t.on("cursorActivity", (t) => {
                                                e.updateArgHints(t);
                                            });
                                    }
                                    t.on("blur", (e) => {
                                        ...
                                        this.$codable.data("cmEditor", t);
                                } else
                                    this.$codable.on("blur", (t) => {
                                        this.context.triggerEvent(
                                            "blur.codeview",
                                            this.$codable.val(),
                                            t,
                        ...
                        hintPopover: class {
                            ...
                            replace() {
                                ...
                                if (t.length) {
                                    ...
                                    if (
                                        ...
                                        n()(e).after(o),
                                            bt.createFromNodeBefore(o).select();
                            ...
                            handleKeydown(t) {
                                this.$popover.is(":visible") &&
                                    (t.keyCode === kt.code.ENTER
                                        ...
                                        : t.keyCode === kt.code.UP
                                          ? (t.preventDefault(), this.moveUp())
                                          : t.keyCode === kt.code.DOWN &&
                                            (t.preventDefault(),
                                            this.moveDown()));
                            }
                            searchKeyword(t, e, o) {
                            ...
                            createGroup(t, e) {
                                ...
                                return (
                                    this.searchKeyword(t, e, (e) => {
                                        (e = e || []).length &&
                                            (o.html(
                                                this.createItemTemplates(t, e),
                                            ),
                                            this.show());
                                    }),
                                    o
                            ...
                            replace() {
                                ...
                                if (e && (e[1] || e[2])) {
                                    ...
                                    this.context.options.linkTargetBlank &&
                                        n()(s).attr("target", "_blank"),
                                        this.lastWordRange.insertNode(s),
                                        (this.lastWordRange = null),
                                        this.context.invoke("editor.focus");
                                }
                            }
                        ...
                        buttons: class {
                            ...
                            addToolbarButtons() {
                                ...
                                for (
                                    ...
                                    this.context.memo("button.style." + e, () =>
                                        this.button({
                                                ...
                                                .buttonGroup([
                                                    ...
                                                    this.ui.dropdownCheck({
                                                        ...
                                                        items: this.options.fontNames.filter(
                                                            this.isFontInstalled.bind(
                                                                this,
                                                            ),
                                                        ),
                                                        title: this.lang.font
                                                            .name,
                                                        template: (t) =>
                            ...
                            updateCurrentStyle(t) {
                                ...
                                if (o["line-height"]) {
                                    ...
                                    e.find(".dropdown-line-height li a").each(
                                        (e, o) => {
                                            const i =
                                                n()(o).data("value") + "" ==
                                                t + "";
                            ...
                            constructor(t) {
                                (this.context = t),
                                    ...
                                    t.memo(
                                        ...
                                        this.options.langInfo.help[
                                            "linkDialog.show"
                                        ],
                                    );
                            }
                            initialize() {
                                const t = this.options.dialogsInBody
                                        ? this.$body
                                        : this.options.container,
                                    e = [
                                        ...
                                        this.ui.onDialogShown(
                                            ...
                                            () => {
                                                this.context.triggerEvent(
                                                    ...
                                                    f.isSupportTouch ||
                                                        i.trigger("focus"),
                                                    this.toggleLinkBtn(n, o, i),
                                                    this.bindEnterKey(i, n),
                            ...
                            update() {
                                ...
                                if (t.isCollapsed() && t.isOnAnchor()) {
                                    ...
                                    this.$popover
                                        ...
                                        .attr("href", o)
                                        .html(o);
                                    const i = ut.posFromPlaceholder(e),
                                        s = n()(
                                            this.options.container,
                                        ).offset();
                                    (i.top -= s.top),
                        ...
                        imageDialog: class {
                            ...
                            initialize() {
                                ...
                                const e = this.options.dialogsInBody
                                        ? this.$body
                                        : this.options.container,
                                    o = [
                        ...
                        tablePopover: class {
                            ...
                            update(t) {
                                ...
                                const e = ut.isCell(t);
                                if (e) {
                                    const e = ut.posFromPlaceholder(t),
                                        o = n()(
                                            this.options.container,
                                        ).offset();
                                    (e.top -= o.top),
        ...
        50: function (t, e, o) {
                        ...
                        this.options.trigger.split(" ").forEach(function (n) {
                            "hover" === n
                                ? (t.off("mouseenter mouseleave"),
                                  t.on("mouseenter", e).on("mouseleave", o))
                                : "click" === n
                                  ? t.on("click", i)
                                  : "focus" === n &&
                                    t.on("focus", e).on("blur", o);
                        });
                    }
                }
                show() {
                    ...
                    i.addClass(r),
                        i.find(".note-tooltip-content").text(s),
            ...
            n()(document).on("click", function (t) {
                n()(t.target).closest(".note-btn-group").length ||
                    (n()(".note-btn-group.open").removeClass("open"),
                    n()(".note-btn-group .note-btn.active").removeClass(
                        "active",
                    ));
            }),
            ...
            var a = class {
                ...
                show() {
                    ...
                    var t = this.$button.next(),
                        ...
                        i = n()(window).width(),
                        s = parseFloat(
                            n()(this.options.target).css("margin-right"),
                        );
                    e.left + o > i - s
                        ? t.css("margin-left", i - s - (e.left + o))
                        : t.css("margin-left", "");
                }
                hide() {
            ...
            const c = s.a.create('<div class="note-editor note-frame"/>'),
                ...
                S = function (t) {
                    return b([
                        ...
                        k([
                            ...
                            b({ className: "note-list", children: t.items[1] }),
                        ]),
                    ]).render();
                },
                $ = function (t) {
                    ...
                    return b({
                        ...
                        children: [
                            v({
                                ...
                                callback: function (t) {
                                    const o = t.find(".note-recent-color");
                                    "foreColor" !== e &&
                                ...
                                click: function (o) {
                                    ...
                                    if (
                                        ...
                                        n.css(o, r),
                                            a.attr("data-" + s, r),
                                            "fore" === e
                                                ? t.itemClick("foreColor", r)
                                                : "back" === e
                                                  ? t.itemClick("backColor", r)
                                                  : t.itemClick(s, r);
                                    }
                                },
                            }),
