...
!(function (jQuery, ytp) {
    (jQuery.mbYTPlayer = {
        ...
        buildPlayer: function (options) {
            return this.each(function () {
                ...
                if (
                    ...
                    (YTPlayer.defaultOpt.containment =
        ...
        playNext: function (a) {
            ...
            return (
                b.checkForStartAt &&
                    (clearTimeout(b.checkForStartAt),
        ...
        playIndex: function (a) {
            ...
            return (
                (a -= 1),
                b.checkForStartAt &&
                    (clearInterval(b.checkForStartAt),
                    clearInterval(b.getState)),
                (b.videoCounter = a),
                    ...
                    ? (jQuery.mbYTPlayer.checkForStart(YTPlayer),
                      void (YTPlayer.getState = setInterval(function () {
                          ...
                          if (
                              ...
                              1 == YTPlayer.player.getPlayerState() &&
                                  (parseFloat(
                                      YTPlayer.player.getDuration() - 0.5,
                              ...
                              (YTPlayer.player.loopTime = YTPlayer.player
                                  .loopTime
                                  ? ++YTPlayer.player.loopTime
                                  : 1),
                                  (startAt = startAt || 1),
        ...
        checkForStart: function (a) {
            ...
            a.player.playVideo(),
                ...
                (a.checkForStartAt = setInterval(function () {
                    jQuery(a).YTPMute();
                    var c =
                        a.player.getVideoLoadedFraction() >=
                        d / a.player.getDuration();
                    if (
