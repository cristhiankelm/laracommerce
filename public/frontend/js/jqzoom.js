(function ($) {
    $.fn.zoom = function (options) {
        ...
        if (
            ...
            $ul.find(".bzoom_big_image").length
        ) {
            ...
            var scalex = _option.thumb_image_width / _option.source_image_width,
                scaley =
                    _option.thumb_image_height / _option.source_image_height,
            ...
            if (!$(".bzoom_magnifier").length) {
                $bzoom_magnifier = $(
                    '<li class="bzoom_magnifier"><div class=""><img src="" /></div></li>',
                );
                ...
                $bzoom_magnifier_img
                    .attr(
                        "src",
                        $ul
                            .find(".bzoom_thumb_active .bzoom_thumb_image")
                            .attr("src"),
                    )
                    .css({
                        width: _option.thumb_image_width,
            ...
            if (!$(".bzoom_zoom_area").length) {
                $bzoom_zoom_area = $(
                    '<li class="bzoom_zoom_area"><div><img class="bzoom_zoom_img" /></div></li>',
                );
                ...
                if (_option.align == "left") {
                    ...
                    left =
                        0 +
                        _option.thumb_image_width +
                        _option.zoom_area_distance;
                }
            ...
            if (!$(".bzoom_small_thumbs").length) {
                var top = _option.thumb_image_height + 10,
                    width = _option.thumb_image_width,
                    smwidth =
                        _option.thumb_image_width / _option.small_thumbs - 10,
                ...
                for (var i = 0; i < _option.small_thumbs; i++) {
                    ...
                    if (i == 0) {
                        html +=
                            '<li class="bzoom_smallthumb_active"><img src="' +
                            smurl +
                            '" alt="small" style="width:' +
                            smwidth +
                            "px; height:" +
                            smheight +
                            'px;" /></li>';
                ...
                $small = $(
                    '<li class="bzoom_small_thumbs" style="top:' +
                        top +
                        "px; width:" +
                        width +
                        'px;"><ul class="clearfix" style="width: 485px;">' +
                        html +
                        "</ul></li>",
                );
                $ul.append($small);
            ...
            function changeLi(index) {
                $ul.find(".bzoom_thumb_active")
                    .removeClass("bzoom_thumb_active")
                    .stop()
                    .animate({ opacity: 0 }, _option.speed, function () {
                        $(this).hide();
                    });
                $small
                    .find(".bzoom_smallthumb_active")
                    .removeClass("bzoom_smallthumb_active")
                    .stop()
                    .animate(
                ...
                $li.eq(index)
                    .addClass("bzoom_thumb_active")
                    .show()
                    .stop()
                    .css({ opacity: 0 })
                    .animate({ opacity: 1 }, _option.speed);
                $small
                    .find("li:eq(" + index + ")")
                    .addClass("bzoom_smallthumb_active")
                    .show()
                    .stop()
                    .css({ opacity: _option.smallthumb_inactive_opacity })
                    .animate({ opacity: 1 }, _option.speed);

                $bzoom_magnifier_img.attr(
                    "src",
                    $li.eq(index).find(".bzoom_thumb_image").attr("src"),
                );
            }
            ...
            $li.add($bzoom_magnifier)
                .mousemove(function (event) {
                    ...
                    if (xpos < _option.thumb_image_width / 2) {
                        ...
                        magx =
                            xpos + magwidth / 2 > _option.thumb_image_width
                                ? _option.thumb_image_width - magwidth
                                : xpos - magwidth / 2;
                    }
                    if (ypos < _option.thumb_image_height / 2) {
                        ...
                        magy =
                            ypos + magheight / 2 > _option.thumb_image_height
                                ? _option.thumb_image_height - magheight
                                : ypos - magheight / 2;
                    }
                ...
                .mouseenter(function (event) {
                    ...
                    $bzoom_zoom_img.attr(
                        "src",
                        $(this).find(".bzoom_big_image").attr("src"),
                    );
                    $bzoom_zoom_area
                    ...
                    $ul.find(".bzoom_thumb_active")
                        .stop()
                        .animate({ opacity: 0.5 }, _option.speed * 0.7);
                    $bzoom_magnifier
                        .stop()
                        .animate({ opacity: 1 }, _option.speed * 0.7)
                        .show();
                })
